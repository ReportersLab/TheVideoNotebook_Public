...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.csv_data'
        db.add_column('core_source', 'csv_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.csv_data'
        db.delete_column('core_source', 'csv_data')
