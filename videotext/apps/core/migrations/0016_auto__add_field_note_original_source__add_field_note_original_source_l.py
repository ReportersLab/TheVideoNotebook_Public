...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Note.original_source'
        db.add_column('core_note', 'original_source', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Note.original_source_link'
        db.add_column('core_note', 'original_source_link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'Note.original_data'
        db.add_column('core_note', 'original_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Source.twitter_user'
        db.add_column('core_source', 'twitter_user', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Source.twitter_hash'
        db.add_column('core_source', 'twitter_hash', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Source.twitter_start_id'
        db.add_column('core_source', 'twitter_start_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Source.twitter_end_id'
        db.add_column('core_source', 'twitter_end_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Source.twitter_search'
        db.add_column('core_source', 'twitter_search', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Note.original_source'
        db.delete_column('core_note', 'original_source')

        # Deleting field 'Note.original_source_link'
        db.delete_column('core_note', 'original_source_link')

        # Deleting field 'Note.original_data'
        db.delete_column('core_note', 'original_data')

        # Deleting field 'Source.twitter_user'
        db.delete_column('core_source', 'twitter_user')

        # Deleting field 'Source.twitter_hash'
        db.delete_column('core_source', 'twitter_hash')

        # Deleting field 'Source.twitter_start_id'
        db.delete_column('core_source', 'twitter_start_id')

        # Deleting field 'Source.twitter_end_id'
        db.delete_column('core_source', 'twitter_end_id')

        # Deleting field 'Source.twitter_search'
        db.delete_column('core_source', 'twitter_search')
