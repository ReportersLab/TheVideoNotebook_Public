...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.user_link'
        db.alter_column('core_note', 'user_link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Note.link'
        db.alter_column('core_note', 'link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Note.source_link'
        db.alter_column('core_note', 'source_link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Note.icon_link'
        db.alter_column('core_note', 'icon_link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'Note.user_link'
        db.alter_column('core_note', 'user_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Note.link'
        db.alter_column('core_note', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Note.source_link'
        db.alter_column('core_note', 'source_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Note.icon_link'
        db.alter_column('core_note', 'icon_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
