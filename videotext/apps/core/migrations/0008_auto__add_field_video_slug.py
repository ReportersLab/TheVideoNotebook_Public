...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_video', 'slug', self.gf('django.db.models.fields.SlugField')(default='September-22nd-GOP-Debate-09222011', unique=True, max_length=256, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.slug'
        db.delete_column('core_video', 'slug')
