...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_source', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='twitter', max_length=32)),
        ...
        db.alter_column('core_video', 'video_url', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Note.source_link'
        db.alter_column('core_note', 'source_link', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.video_url'
        db.alter_column('core_video', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=256))
    ...
    models = {
        ...
        'core.video': {
            ...
            'video_url': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'})
        }
    }
