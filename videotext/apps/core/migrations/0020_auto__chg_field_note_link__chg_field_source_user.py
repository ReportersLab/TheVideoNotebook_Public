...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_note', 'link', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Source.user'
        db.alter_column('core_source', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Source.user'
        db.alter_column('core_source', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
