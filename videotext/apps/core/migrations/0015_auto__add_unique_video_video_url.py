...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Video', fields ['video_url']
        db.create_unique('core_video', ['video_url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Video', fields ['video_url']
        db.delete_unique('core_video', ['video_url'])
