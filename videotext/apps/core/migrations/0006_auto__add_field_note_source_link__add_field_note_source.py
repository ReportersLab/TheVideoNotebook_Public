...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Note.source_link'
        db.add_column('core_note', 'source_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Note.source'
        db.add_column('core_note', 'source', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Note.source_link'
        db.delete_column('core_note', 'source_link')

        # Deleting field 'Note.source'
        db.delete_column('core_note', 'source')
