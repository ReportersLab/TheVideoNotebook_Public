...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.update_time'
        db.alter_column('core_video', 'update_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Note.update_time'
        db.alter_column('core_note', 'update_time', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Video.update_time'
        raise RuntimeError("Cannot reverse this migration. 'Video.update_time' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Note.update_time'
        raise RuntimeError("Cannot reverse this migration. 'Note.update_time' and its values cannot be restored.")
    ...
    models = {
        ...
        'core.note': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 19, 13, 35, 13, 471765)', 'null': 'True', 'blank': 'True'}),
