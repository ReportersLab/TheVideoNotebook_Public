...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Note.import_source_name'
        db.add_column('core_note', 'import_source_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Note.import_source_name'
        db.delete_column('core_note', 'import_source_name')
    ...
    models = {
        ...
        'core.note': {
            ...
            'import_source_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'core.source': {
            ...
            'srt_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
