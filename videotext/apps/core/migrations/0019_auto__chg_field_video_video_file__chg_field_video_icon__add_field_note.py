...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_video', 'video_file', self.gf('django.db.models.fields.files.FileField')(max_length=512, null=True))

        # Changing field 'Video.icon'
        db.alter_column('core_video', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=512, null=True))

        # Adding field 'Note.import_source'
        db.add_column('core_note', 'import_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Source'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Video.video_file'
        db.alter_column('core_video', 'video_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Video.icon'
        db.alter_column('core_video', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Deleting field 'Note.import_source'
        db.delete_column('core_note', 'import_source_id')
