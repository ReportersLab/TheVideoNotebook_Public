...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.video_length'
        db.add_column('core_video', 'video_length', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'Note.offset'
        db.add_column('core_note', 'offset', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.video_length'
        db.delete_column('core_video', 'video_length')

        # Deleting field 'Note.offset'
        db.delete_column('core_note', 'offset')
