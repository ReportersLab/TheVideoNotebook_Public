...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.scraped'
        db.add_column('core_source', 'scraped', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Source.content'
        db.add_column('core_source', 'content', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.scraped'
        db.delete_column('core_source', 'scraped')

        # Deleting field 'Source.content'
        db.delete_column('core_source', 'content')
