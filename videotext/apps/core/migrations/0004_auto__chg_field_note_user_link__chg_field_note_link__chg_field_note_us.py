...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.user_name'
        db.alter_column('core_note', 'user_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Note.user_link'
        db.alter_column('core_note', 'user_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Note.link'
        db.alter_column('core_note', 'link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Note.user_name'
        db.alter_column('core_note', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Note.icon_link'
        db.alter_column('core_note', 'icon_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
