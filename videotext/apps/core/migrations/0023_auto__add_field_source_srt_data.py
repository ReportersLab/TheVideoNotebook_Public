...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.srt_data'
        db.add_column('core_source', 'srt_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.srt_data'
        db.delete_column('core_source', 'srt_data')
